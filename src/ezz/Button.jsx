...
import Sucsses from './Sucsses.jsx';
...
const Button = () => {
  ...
  return (
      <div id="tabs" className=' d-flex justify-content-center align-items-center border-bottom-1'>
        <div>
        </div>
        <menu>
          ...
          {buttonsText.map((item, index) => (
            ...
            onClick={() => setActiveContentIndex(index)}> {item.text} </button>
            ))}
          </div>
          <div className="underButtons">
          <div className='content '>
            <div className='content1'>
              <h2 className=' mt-5 text-3xl m-2' >{content1[activeContentIndex].title}</h2>
            ...
            <img async src={head} alt="head photo " className=' img-fluid  rounded-3 ' />
            <div className='content2'>
              <h2 className=' mt-5 text-3xl mb-2' >{content2[activeContentIndex].title1}</h2>
              <div className="insideContent1 mb-6 ml-6">
              <ul>
              ...
              <h2 className=' mt-5'>{content2[activeContentIndex].title2}</h2>
          ...
          <h1>Don't Miss the Opportunity <br /> Let's Create Something!</h1>
